...
Business consultant agency project
Site created with the objective of studying HTML and CSS.
...
⮞ JavaScript Beginner 
  -Functions
  -Arrays
  -Loops if/while/forEach
  -Console
⮞ Wordpress
  - Instalation / SetUp / Control pannel
  - User Management
  - Plugin Management
  - Custom Fields
  - PHP for WP basics - Templates creation
  - Child theme
